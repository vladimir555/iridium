...
namespace iridium {
/// \~english @brief Namespace for logging related functionalities.
/// \~russian @brief Пространство имен для функциональности, связанной с логированием.
namespace logging {
/// \~english @brief Namespace for logging configuration structures and settings.
/// \~russian @brief Пространство имен для структур конфигурации и настроек логирования.
namespace config {
