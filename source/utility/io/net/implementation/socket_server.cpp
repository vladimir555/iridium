...
#include "utility/io/implementation/transmitter.h"
#include "utility/io/implementation/stream_buffer.h"
#include "utility/io/implementation/stream_reader_list.h"
#include "utility/pattern/implementation/initializer.h"

#include "utility/parsing/implementation/parser_http.cpp"
#include "utility/io/protocol/http/request.h"
#include "utility/io/protocol/http/response.h"
#include "utility/io/protocol/http/implementation/content_storage.h"
...
//using utility::io::implementation::CStreamProxy;
//using utility::io::implementation::CTransmitter;
using utility::io::IListener;
using utility::io::IStream;
using utility::io::implementation::CStreamReaderBuffer;
using utility::io::implementation::CStreamWriterBuffer;
using utility::io::implementation::CStreamReaderList;
//using utility::io::protocol::IProtocol;
using utility::io::protocol::IProtocolFactory;
//using utility::io::protocol::http::implementation::CProtocol;
using utility::io::protocol::http::implementation::CContentStorage;
using utility::convertion::convert;
using utility::pattern::implementation::CInitializer;
