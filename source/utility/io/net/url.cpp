...
IMPLEMENT_ENUM(utility::io::net::URL::TProtocol)
...
utility::io::net::URL createURL(string const &value) {
    return utility::io::net::URL(value); // ----->
}


string getAddress(utility::io::net::URL const &url) {
...
IMPLEMENT_CONVERT(utility::io::net::URL, std::string, createURL)
IMPLEMENT_CONVERT(std::string, utility::io::net::URL, getAddress)
