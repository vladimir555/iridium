...
DEFINE_CONVERT(utility::io::protocol::http::request::THttp::TMessageLine, std::string)
DEFINE_CONVERT(std::string, utility::io::protocol::http::request::THttp::TMessageLine)
