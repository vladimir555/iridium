...
IMPLEMENT_CONVERT(utility::io::protocol::http::response::THttp::TMessageLine, std::string, utility::io::protocol::http::response::convertToMessageLine)
IMPLEMENT_CONVERT(std::string, utility::io::protocol::http::response::THttp::TMessageLine, utility::io::protocol::http::response::convert)


IMPLEMENT_CONVERT(utility::io::protocol::http::response::THttp::THeaders::THTTPDate, std::string, utility::io::protocol::http::response::convertToHTTPDate)
IMPLEMENT_CONVERT(std::string, utility::io::protocol::http::response::THttp::THeaders::THTTPDate, utility::io::protocol::http::response::convert)
