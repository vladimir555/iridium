...
IMPLEMENT_CONVERT(utility::protocol::http::response::THttp::TMessageLine, std::string, utility::protocol::http::response::convertToMessageLine)
IMPLEMENT_CONVERT(std::string, utility::protocol::http::response::THttp::TMessageLine, utility::protocol::http::response::convert)


IMPLEMENT_CONVERT(utility::protocol::http::response::THttp::THeaders::THTTPDate, std::string, utility::protocol::http::response::convertToHTTPDate)
IMPLEMENT_CONVERT(std::string, utility::protocol::http::response::THttp::THeaders::THTTPDate, utility::protocol::http::response::convert)
