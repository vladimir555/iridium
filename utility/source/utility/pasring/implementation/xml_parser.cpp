...
void CXMLParser::parse(std::string const &source) {
    ...
    m_root_node         = convertXMLNodeToNode(xml_root_node);
}


std::string CXMLParser::compose() const {
    TXMLDocument xml_document;
    ...
    auto xml_root_node = convertNodeToXMLNode(m_root_node, nullptr, xml_document);
